                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="border p-2">
                                <b>Adress 1: </b> {{$order->address1}}
                                <br>
                                <b>Address 2: </b>{{$order->address2}}
                                <br>
                                <b>City: </b>{{$order->city}}
                                <br>
                            ...
                            </b><label class="my-1" for="">ZIP CODE</label>
                        ...
                        <div class="col-md-6 table-responsive">
                            ...
                            <h4 class="px-2">Grand Total : <span class="float-end">BDT {{ $order->total_price }}</span></h4>
                         </div>
                    </div>
