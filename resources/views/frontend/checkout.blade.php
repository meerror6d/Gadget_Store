                        ...
                        <div class="card-body">
                            ...
                            <div class="row checkout-form">
                                ...
                                <div class="col-md-6  my-2">
                                    ...
                                    <input type="number" name="phoneno" class="form-control"  value="{{Auth::user()->phoneno}}"  placeholder="+88" required>
                                </div>
                                <div class="col-md-6  my-2">
                                ...
                                <div class="col-md-6  my-2">
                                    ...
                                    <input type="text" name="city" class="form-control" value="{{Auth::user()->city}}"   placeholder="Mymensingh" required>
                                </div>
                                <div class="col-md-6  my-2">
                                    <label for="email">State</label>
                                    <input type="text" name="state" class="form-control"  value="{{Auth::user()->state}}"  placeholder="ZILLA" required>
                                </div>
                                <div class="col-md-6  my-2">
                                    <label for="email">Country</label>
                                    <input type="text" name="country" class="form-control" value="{{Auth::user()->country}}"   placeholder="Bangladesh" required>
                                </div>
                                <div class="col-md-6  my-2">
                                    <label for="email">Zip Code</label>
                                    <input type="number" name="pincode" class="form-control" value="{{Auth::user()->pincode}}"   placeholder="Pin code" required>
                                </div>
                            </div>
                        </div>
                    </div>
